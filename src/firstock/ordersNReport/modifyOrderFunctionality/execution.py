...
class FirstockModifyOrder:
    def __init__(self, qty, orderNumber, trgprc, product, prc, tradingSymbol, priceType, userId, retention, mkt_protection=None):
    ...
    def firstockModifyOrder(self):
        result = self.modifyOrder.firstockModifyOrder(
            qty=self.qty,
            ...
            mkt_protection=self.mkt_protection
        )
        return result